...
var _user$project$Bingo$initialEntries = {
	...
	_1: {
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: A4(_user$project$Bingo$Entry, 4, 'Rock star Ninja', 300, false),
				_1: {ctor: '[]'}
			}
		}
	}
};
var _user$project$Bingo$initialModel = {name: 'mike', gameNumber: 3, entries: _user$project$Bingo$initialEntries};
